...
import { deleteTask, getTodayTasks, setTaskCompleted, setTaskNotCompleted } from '../../../../Services/UserTasksService';
...
export default function TodayTaskList() {
    const { data: todayTasks, status: tasksStatus, error: tasksError, refetch: getTodayTasksRefetch } = getTodayTasks(new Date(Date.now()));
